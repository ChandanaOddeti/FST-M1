...
Selcet order_no from orders order by order_date asc;
...
Select Count(salesman_id) As "Total Salesman" from orders;

Select Count(distinct salesman_id) As "Total Salesman" from orders;

Select customer_id,max(purchase amount) as "Max Amount" from orders group by "customer_id" ;
